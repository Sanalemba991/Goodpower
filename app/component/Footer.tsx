        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3">
              ...
              <li>
                 <Link href="/faq" className="text-sm text-slate-400 hover:text-amber-400 transition-colors duration-200 flex items-center group">
                    <span className="opacity-0 group-hover:opacity-100 transition-opacity mr-1">›</span> 
                    FAQ
                  </Link>
              </li>
          ...
          <div className="lg:col-span-4">
            ...
            <div className="space-y-4 text-sm mb-6">
              <div className="flex items-start gap-3">
                ...
                <span className="text-slate-400">No. 88 Industrial Road, Shenzhen, China</span>
              </div>
              <div className="flex items-center gap-3">
                <svg className="w-5 h-5 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+86-13631634942" className="hover:text-white transition-colors">+86-136 3163 4942</a>
              </div>
              <div className="flex items-center gap-3">
                 <svg className="w-5 h-5 text-amber-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:quanyi@funpack.com.cn" className="hover:text-white transition-colors break-all">quanyi@funpack.com.cn</a>
              </div>
            </div>
